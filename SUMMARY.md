...
* [銀行家尼莫](bankernemo/README.md)
   ...
   * [0322訪談銀行家尼莫的價值投資人生](bankernemo/0322fang_tan_yin_xing_jia_ni_mo_de_jia_zhi_tou_zi_.md)
...
* [讀書心得](book/README.md)
   ...
   * [財報狗教你挖好股穩賺20%](book/cai_bao_gou_jiao_ni_wa_hao_gu_wen_zhuan_20.md)
...
* [雷浩斯](redhouse/README.md)
   ...
   * [巴菲特選股法，從『資本支出』額度，篩出三種不同等級『自由現金流』的公司！](redhouse/ba_fei_te_xuan_gu_fa_ff0c_cong_300e_zi_ben_zhi_chu.md)
...
* [籌碼面](positioncalculation/chou_ma_mian.md)
   * [籌碼面止跌訊號](positioncalculation/chou_ma_mian_zhi_die_hao.md)
...
* [洪鑑穩](iqvalue/hong_jian_wen.md)
   ...
   * [【市場永遠是對的嗎？】](iqvalue/3010_shi_chang_yong_yuan_shi_dui_de_ma_ff1f_3011.md)
...
* [心得](Yao/xin_de.md)
   ...
   * [找飆股](Yao/zhao_biao_gu.md)
       * [挑股2步驟，免費網站也能挖出月漲幅60%的飆股！](Yao/tiao_gu_2_bu_zou_ff0c_mian_fei_wang_zhan_ye_neng_w.md)
   * [存股](Yao/cun_gu.md)
...
* [美股投資](US_STOCK/mei_gu_tou_zi.md)
   ...
   * [美股資源](US_STOCK/mei_gu_gong_ju_wang_zhan.md)
...
1. 核心判斷  
同產業一起漲，通常反映「需求想像」與資金先行；  
但最後誰能把需求變成營收、毛利、現金流，取決於各公司自己的產能、技術成熟度、供應鏈、管理執行與財務體質。  
所以題材先同漲，基本面再分化。

2. 如何用數據衡量「題材先同漲」  
可用同產業成分股做以下指標：
- `Breadth`：當日上漲檔數 / 總檔數
- `Abnormal Breadth`：當日超額報酬為正（`r_i - beta_i * r_mkt > 0`）的比例
- `Co-movement`：族群內平均兩兩報酬相關係數（5~20 日滾動）
- `Volume Z-score`：個股成交量相對過去 60 日的標準分數
- `同步爆量比`：同日 `Volume Z > 2` 的檔數比例
...
在財報/營收公告後，觀察：
- 橫斷面報酬分散度（Std）是否上升
- 報酬是否開始與基本面（營收 YoY、毛利率、OCF）顯著相關  
若是，代表市場從「題材共振」轉為「公司體質定價」。
